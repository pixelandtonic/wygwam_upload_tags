...
* Create a folder called “wygwam_upload_tags” in system/expressionengine/third_party/
* Upload ext.wygwam_upload_tags.php to system/expressionengine/third_party/wygwam_upload_tags/
